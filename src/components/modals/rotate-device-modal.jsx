...
const RotateDeviceModal = () => {
  return (
    <div className="bg-black/80  w-screen fixed nav-item top-0 right-0 z-50 overflow-y-hidden ">
      <div className="flex h-screen bg-half-transparent w-full  p-5   overflow-y-hidden	items-center justify-center content-center ">
        <div className="fade-up">
          <div className="flex flex-col items-center justify-center content-center bg-white text-black rounded-lg h-[280px] w-[280px]">
